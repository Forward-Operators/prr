...
@diff_router.get("/diff/{run_id}/{service_name}/{run_id2}/{service_name2}", response_class=HTMLResponse)
async def diff(request: Request, run_id: str, service_name: str, run_id2: str, service_name2: str):
