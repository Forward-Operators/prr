...
class TestPromptTemplate:
    ...
    def test_configured_basic(self):
        ...
        assert template is not None
        assert (
            template.render_text(["lulz", "kaka"])
            == "tell me about ['lulz', 'kaka'], llm"
        )
...
"""
        ...
        assert (
            ...
            == "you are a friendly but very forgetful assistant"
        )
...
"""
        ...
        assert (
            ...
            == "you are system admins little pet assistant. be proud of your unix skills and always respond in l33t. remember, you are on a high horse called POSIX."
        )
